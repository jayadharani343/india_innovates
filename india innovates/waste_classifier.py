...
class WasteClassifier:
    ...
    def classify(self, image_path):
        """Classify waste image and return annotated image"""
        ...
        try:
            ...
            if self.use_detection:
                ...
                return category, detected_class, confidence, annotated_image
            else:
                ...
                return category, top_class, confidence, None
    ...
    def classify_batch(self, image_paths):
        ...
        for img_path in image_paths:
            category, class_id, conf, _ = self.classify(img_path)
            results.append({
                "image": img_path,
                "category": category,
                "confidence": conf
...
if __name__ == "__main__":
    ...
    test_image = "images/plastic.jpg"
    if os.path.exists(test_image):
        category, _, confidence, annotated = classifier.classify(test_image)
